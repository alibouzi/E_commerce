                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                if($error_message != '') {
                                    echo "<div class='alert alert-danger alert-dismissible fade show' style='padding: 10px;background:#f1f1f1;margin-bottom:20px;'> <button type='button' class='close' data-dismiss='alert'>&times;</button>  ".$error_message."</div>";
                                }
                                if($success_message != '') {
                                ...
                                <div class="col-md-6 form-group">
                                    <label for=""></label>
                                    <input type="submit" class="btn btn-outline-primary" value="<?php echo LANG_VALUE_15; ?>" name="form1">
