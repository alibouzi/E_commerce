...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="deg/fonts/icomoon/style.css">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="deg/css/bootstrap.min.css">
    
    <!-- Style CSS -->
    <link rel="stylesheet" href="deg/css/style.css">
  ...
  <body>
    ...
    <script src="deg/js/jquery-3.3.1.min.js"></script>
    <script src="deg/js/popper.min.js"></script>
    <script src="deg/js/bootstrap.min.js"></script>
  </body>
</html>