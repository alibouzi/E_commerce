...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 13 mai 2021 à 15:21
...
(6, '??? ????? ?????', 'tunisia', 'alibouzid323@gmail.com', '21463312', 221, 'bou3sida 3546', 'sfax', 'Sélectionner', '3034', '', '', '', 0, '', '', '', '', '', '', '', 0, '', '', '', '', '202cb962ac59075b964b07152d234b70', '6d01946d0adbe6c5eeea62554f2383e8', '2021-05-13 02:31:56', '1620858716', 1);
...
(82, 'hali', '12', '120', 20, 'product-featured-82.png', '', '', '', '', '', 0, 0, 0, 27);
...
(5, 'Easy Returns', 'Return any item before 15 days. No questions asked.', 'service-5.gif'),
(6, 'Free Shipping', 'Enjoy free shipping in U.A.E. More countries to be added sooner.', 'service-6.gif'),
...
CREATE TABLE `tbl_settings` (
  ...
  `contact_fax` varchar(55) NOT NULL,
  `contact_map_iframe` text NOT NULL,
  `receive_email` varchar(55) NOT NULL,
  `receive_email_subject` varchar(55) NOT NULL,
  ...
  `banner_login` varchar(55) NOT NULL,
  `banner_registration` varchar(55) NOT NULL,
  `banner_forget_password` varchar(55) NOT NULL,
  `banner_reset_password` varchar(55) NOT NULL,
  `banner_search` varchar(55) NOT NULL,
  `banner_cart` varchar(55) NOT NULL,
  `banner_checkout` varchar(55) NOT NULL,
  `banner_product_category` varchar(25) NOT NULL,
  `banner_blog` varchar(55) NOT NULL,
  `cta_title` varchar(55) NOT NULL,
  `cta_content` text NOT NULL,
  `cta_read_more_text` varchar(55) NOT NULL,
  `cta_read_more_url` varchar(55) NOT NULL,
  `cta_photo` varchar(55) NOT NULL,
  `featured_product_title` varchar(55) NOT NULL,
  `featured_product_subtitle` varchar(55) NOT NULL,
  `latest_product_title` varchar(55) NOT NULL,
  `latest_product_subtitle` varchar(55) NOT NULL,
  `popular_product_title` varchar(55) NOT NULL,
  `popular_product_subtitle` varchar(55) NOT NULL,
  `testimonial_title` varchar(55) NOT NULL,
  `testimonial_subtitle` varchar(55) NOT NULL,
  `testimonial_photo` varchar(55) NOT NULL,
...
(1, 'slider-1.gif', 'Welcome to Haykel Shop', 'Shop Online for Latest Women Accessories', 'Shop Women Accessories', '', 'Center'),
...
(4, 'slider-4.jpg', 'Promotion  jus qua 30%', '', 'Read more', '', 'Center');
...
(3, 'LinkedIn', 'https://www.twitter.com/fashionys', 'fa fa-linkedin'),
(4, 'Google Plus', 'https://www.twitter.com/fashionys', 'fa fa-google-plus'),
(5, 'Pinterest', 'https://www.twitter.com/fashionys', 'fa fa-pinterest'),
(6, 'YouTube', 'https://www.twitter.com/fashionys', 'fa fa-youtube'),
(7, 'Instagram', 'https://www.twitter.com/fashionys', 'fa fa-instagram'),
(8, 'Tumblr', '', 'fa fa-tumblr'),
(9, 'Flickr', '', 'fa fa-flickr'),
(10, 'Reddit', '', 'fa fa-reddit'),
(11, 'Snapchat', 'https://www.twitter.com/fashionys', 'fa fa-snapchat'),
(12, 'WhatsApp', 'https://www.twitter.com/fashionys', 'fa fa-whatsapp'),
...
(11, 'alibouzid323@gmail.com', '2021-05-13', '2021-05-13 15:00:28', '6df5f0b7e6b79951dabebe11166fd251', 0);
...
(1, 'Ouled bouzid ali', 'alibouzid@gmail.com', '', '86318e52f5ed4801abe1d13d509443de', 'user-1.jpg', 'Super Admin', 'Active'),
(13, 'Haykel ', 'haykel@gmail.com', '', '86318e52f5ed4801abe1d13d509443de', 'user-13.jpg', 'Admin', 'Active');
